...
public class PersonAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View onePersonLine;
        //Create an infaltor that will turn raw XML into a view
        LayoutInflater inflator =  (LayoutInflater)mActivity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);

        //Initilize the onePersonLine xml file to the inflator. reference to layout
        onePersonLine = inflator.inflate(R.layout.person_one_line, parent , false);

        //Assign the vars to the actaul views on the layout
        ...
        //Assign values to text views and image view
