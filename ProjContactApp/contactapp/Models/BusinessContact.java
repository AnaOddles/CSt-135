...
public class BusinessContact extends BaseContact {
    ...
    public BusinessContact() {
        super("No name", "No last name", null, null, "no email");
    }

    // Constructor with parameters
    public BusinessContact(String firstName, String lastName, Address address, Photo photo,
                           String email, String opening, String closing, String daysAWeekOpen, String websiteURL) {
        super(firstName, lastName, address, photo, email);
